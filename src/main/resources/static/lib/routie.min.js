...
var Routie = function (a, b) {
    var c = [], d = {}, e = "routie", f = a[e], g = function (a, b) {
    ...
    g.prototype.addHandler = function (a) {
        ...
        for (var d = 1, e = c.length; e > d; ++d) {
            var f = this.keys[d - 1], g = "string" == typeof c[d] ? decodeURIComponent(c[d]) : c[d];
    ...
    var h = function (a, b, c, d) {
        ...
        var e = a.split(" "), f = 2 == e.length ? e[0] : null;
        a = 2 == e.length ? e[1] : e[0], d[a] || (d[a] = new g(a, f), c.push(d[a])), d[a].addHandler(b)
    }, j = function (a, b) {
        if ("function" == typeof b) i(a, b), j.reload(); else if ("object" == typeof a) {
